...
public class MainMenu extends JFrame {
    ...
    private JButton b1, b2, b3, b4, bSignOut, bAddClient, bAddCar;
    ...
    public MainMenu(Client client) {
     ...
     // Inside the constructor of MainMenu (add this in p5, where user-related buttons like "Sign Out" are placed)
